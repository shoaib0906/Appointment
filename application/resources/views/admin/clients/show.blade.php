...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           @lang('quickadmin.clients.title') @lang('quickadmin.qa_view')
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>@lang('quickadmin.clients.fields.visitor_per_hour')</th>
                            <td>{{ $client->visitor_per_hour }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.clients.fields.start_time')</th>
                            <td>{{ $client->start_time }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.clients.fields.end_time')</th>
                            <td>{{ $client->finish_time }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.clients.fields.lunch_start_time')</th>
                            <td>{{ $client->lunch_start_time }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.clients.fields.lunch_end_time')</th>
                            <td>{{ $client->lunch_finish_time }}</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
