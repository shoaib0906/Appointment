...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('service_id', 'Executive*', ['class' => 'control-label']) !!}
                    {!! Form::select('executive_id', $client, old('executive_id'), ['class' => 'form-control select2', 'required' => '', 'multiple' => '', 'name' => 'executive_id']) !!}
                    <p class="help-block"></p>
