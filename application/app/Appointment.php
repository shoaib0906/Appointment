...
class Appointment extends Model
{
    ...
    protected $fillable = ['start_time','date' ,'comments', 'client_id', 'employee_id','user_id','status'];
    /**
   ...
   /* public function setStartTimeAttribute($input)
    {
        if ($input != null && $input != '') {
            $this->attributes['start_time'] = Carbon::createFromFormat(config('app.date_format') . ' H:i:s', $input)->format('H:i:s');
        } else {
