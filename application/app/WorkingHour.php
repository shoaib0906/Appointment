...
class WorkingHour extends Model
{
    ...
    protected $fillable = ['date', 'start_time', 'finish_time', 'executive_id','comments'];
    ...
    {
        $this->attributes['executive_id'] = $input ? $input : null;
    }
    ...
    {
        return $this->belongsTo(Client::class, 'executive_id')->withTrashed();
    }
